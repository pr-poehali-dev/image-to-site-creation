    ...
    <div className="min-h-screen bg-background text-brand-dark font-sans overflow-x-hidden">
      ...
      <section className="relative grid-pattern">
        ...
        <div className="container mx-auto relative py-16 lg:py-20 max-w-3xl">
          ...
          <span className="text-brand font-display font-bold text-sm tracking-widest uppercase">{post.tag}</span>
      ...
      <section className="container mx-auto pb-20 max-w-3xl">
        <div className="w-full h-48 md:h-64 rounded-3xl bg-gradient-to-br from-brand to-brand-graphite/20 flex items-center justify-center mb-10">
          <Icon name={post.icon} size={64} className="text-brand-dark/80" />
        </div>
              ...
              {otherPosts.map((p) => (
                <Link key={p.slug} to={`/blog/${p.slug}`} className="flex items-center gap-5 bg-white border border-black/5 rounded-2xl p-5 hover-lift">
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-brand to-brand flex items-center justify-center shrink-0">
                    <Icon name={p.icon} size={26} className="text-brand-dark" />
                  </div>
                  <div>
